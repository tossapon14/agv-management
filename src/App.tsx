...
function App() {
  const [linkFocused,setlinkfocused] = useState<string[]>(Array(5).fill("")); 
  useEffect(() =>{
        ...
        <section className='content'>
         <div className="drawer">
             <ul>
               ...
               หน้าหลัก</a></li>
               <li><a href="/mission" className={linkFocused[1]}><BiFile size='32'></BiFile>งานบริการ</a></li>
               ...
               <li><a href="/login" className={linkFocused[4]}><IoIosLogIn size='32'></IoIosLogIn>เข้าสู่ระบบ</a></li>
             </ul>
