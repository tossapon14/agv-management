    ...
    <div className="statistics-box">
      ...
      {!checkNetwork ? <NetworkError /> : <>
        <div className='option-miss-or-pall'>
          <h5 style={{ marginRight: "16px" }}>{t('display-information')}</h5>
        ...
        <div className='stat-card-box flex-wrap flex-md-nowrap'>
          <div className='stat-card'>
            <div className='d-flex align-items-center mt-3 ms-3'>
              <div className='stat-box-icon' style={{ backgroundColor: "rgb(210, 246, 255)" }}>
            ...
            <div className="label-footer" style={{ backgroundColor: "rgb(236, 251, 255)" }}>
              {textShowFooter[0] || ""}
            </div>
          </div>
          <div className='stat-card'>
            <div className='d-flex align-items-center mt-3 ms-3'>
              <div className='stat-box-icon' style={{ backgroundColor: "#e4ffd8" }}>
            ...
            <div className="label-footer" style={{ backgroundColor: "rgb(231, 254, 235)" }}>
              {textShowFooter[1] || ""}
            </div>
          </div>
          <div className='stat-card'>
            <div className='d-flex align-items-center mt-3 ms-3'>
              <div className='stat-box-icon' style={{ backgroundColor: "#ffdcdc" }}>
                <MdCancel color="#ff6d6d" size={24} />
              </div>
              <p>{t("cancel")}</p>
            </div>
            <div className='stat-number'>{optionMissOrPall! < 2 ? totalMission!.cancel : totalMission!.cancel * 8}</div>
            <div className="label-footer" style={{ backgroundColor: "rgb(254, 235, 235)" }}>
              {textShowFooter[2] || ""}
            </div>
          </div>
          <div className='stat-card'>
            <div className='d-flex align-items-center mt-3 ms-3'>
              <div className='stat-box-icon' style={{ backgroundColor: "rgb(235, 235, 235" }}>
            ...
            <div className="label-footer" style={{ backgroundColor: "rgb(240, 240, 240)" }}>
              {textShowFooter[3] || ""}
            </div>
          </div>
        </div>
